					...
					<div class="g1-collection">
						...
						<div class="g1-collection-viewport">
							<ul class="g1-collection-items">
								...
								$bimber_post_number ++; ?>
									<?php do_action( 'bimber_home_loop_before_post', 'carmania', $wp_query->current_post + 1 ); ?>

									<li class="g1-collection-item g1-collection-item-carmania">
										<?php if ( 3 === $bimber_post_number ) :?>
											<?php get_template_part( 'template-parts/content-tile-carmania', get_post_format() ); ?>
										<?php else : ?>
											<?php get_template_part( 'template-parts/content-carmania', get_post_format() ); ?>
										<?php endif; ?>
									</li>

									<?php do_action( 'bimber_home_loop_after_post', 'carmania', $wp_query->current_post + 1 ); ?>
								<?php endwhile; ?>
							</ul>
						</div>
