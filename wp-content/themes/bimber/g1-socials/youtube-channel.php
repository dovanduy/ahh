...
<p class="g1-youtube-channel-name g1-delta g1-delta-1st">
...
<p class="g1-youtube-follow">
	<a class="g1-button g1-button-s g1-button-simple" href="<?php echo ( esc_url( 'https://www.youtube.com/channel/' . $channel_id ) ); ?>" rel="me" target="_blank"><?php esc_html_e( 'Subscribe', 'g1_socials' ); ?></a>
</p>
