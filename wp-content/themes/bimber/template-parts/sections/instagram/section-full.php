...
?>
	<div class="g1-row g1-row-wide g1-row-layout-page g1-section-background g1-instagram-section<?php echo( $invert ? ' g1-dark' : '' ); ?>">
		<div class="g1-row-inner">
			<div class="g1-column">
					<?php
					if ( 'compressed' === $bimber_instagram_section_type ) {
						get_template_part( 'template-parts/sections/instagram/base', 'compressed' );
					} else {
						get_template_part( 'template-parts/sections/instagram/base', 'expanded' );
					}
					?>
			</div>
		</div>
