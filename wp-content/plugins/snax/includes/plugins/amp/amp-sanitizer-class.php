...
<?php
/**
 * AMP replacement saniztizer class
 *
...
if ( ! class_exists( "AMP_Base_Sanitizer" ) ) {
	include_once AMP__DIR__ . "/includes/sanitizers/class-amp-base-sanitizer.php";
}

class Snax_AMP_Blacklist_Sanitizer extends AMP_Base_Sanitizer {
