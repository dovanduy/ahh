...
<?php do_action( 'snax_before_frontend_submission_form', 'versus_poll' ); ?>

	<form action="" method="post" class="<?php echo implode( ' ', array_map( 'sanitize_html_class', $snax_class ) ); ?>">
		<?php do_action( 'snax_frontend_submission_form_start', 'versus_poll' ); ?>
		...
		<?php do_action( 'snax_frontend_submission_form_end', 'versus_poll' ); ?>
	</form>

<?php do_action( 'snax_after_frontend_submission_form', 'versus_poll' ); ?>
